...
public class MemberView {
	...
	private void selectMyInfo() {
		...
		System.out.print("성별 : ");
		if(loginMember.getMemberGender().equals("M")) System.out.println("남");
			...
			if(memberList.isEmpty()) System.out.println("\n조회 결과가 없습니다.\n");
				...
				for(Member mem : memberList) {
					System.out.printf("%10s %5s %3s\n", mem.getMemberId(),
							mem.getMemberName(), mem.getMemberGender());
				}
			}
	...
	private void updateMember() {
		try {
			...
			int result = service.updatMember(member);
