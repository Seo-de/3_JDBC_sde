...
public class EmployeeView {
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				input = -1; // 반복문 첫 번째 바퀴에서 잘못 입력하면 종료되는 상황 방지
	...
	public void selectEmpId() {
		...
		// 입력 받은 사번은 DAO의 selectEmpId() 메서드로 전달하여
		// 조회된 사원 정보 반환 받기
	...
	public int inputEmpId() {
		...
		int empId = sc.nextInt(); // 버퍼에 남은 개행문자 제거
	...
	public void insertEmployee() {
		...
		// INSERT, UPDATE, DELECT 같은 DML 구문은
	...
	public void updateEmployee() { 
		...
		int result = dao.updateEmployee(emp); // UPDATE(DML) -> 반영된 행이 개수 반환(int형)
	...
	public void deleteEmployee() {
		System.out.print("<사번이 일치하는 사원 정보 삭제>");
	...
	public void selectSalary() {
		...
		List<Employee> list = dao.selectSalary(salary);
		
		printAll(dao.selectSalary(salary));
